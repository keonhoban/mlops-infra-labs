...
- 전체 구성 및 실습 설명은 블로그에서 확인할 수 있습니다.  
👉 [🔗 MLOps 실무 구축 여정 시리즈](https://keonhoban.github.io/mlops-journey/)
...
- **반건호 / Keonho Ban**
- [GitHub](https://github.com/keonhoban) | [Blog](https://keonhoban.github.io/mlops-journey/)
